...
envsubst '$$BACKEND_PORT_INTERNAL $$DOMAIN $$MAILHOG_UI_PORT_INTERNAL $$MINIO_PORT_INTERNAL $$MINIO_CONSOLE_PORT_INTERNAL $$KAFKA_UI_PORT_INTERNAL' < /etc/nginx/nginx.conf.template > /etc/nginx/nginx.conf
