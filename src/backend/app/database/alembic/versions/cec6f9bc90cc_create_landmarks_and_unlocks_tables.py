...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_landmarks_area_id"), "landmarks", ["area_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_unlock_area_landmark", "unlocks", ["area_id", "landmark_id"], unique=False
    )
    op.create_index(
        "idx_unlock_area_unlocked_at",
        "unlocks",
        ["area_id", "unlocked_at"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_unlock_landmark_unlocked_at",
        "unlocks",
        ["landmark_id", "unlocked_at"],
        unique=False,
    )
    op.create_index(
        "idx_unlock_user_landmark", "unlocks", ["user_id", "landmark_id"], unique=False
    )
    op.create_index(
        "idx_unlock_user_unlocked_at",
        "unlocks",
        ["user_id", "unlocked_at"],
        unique=False,
    )
